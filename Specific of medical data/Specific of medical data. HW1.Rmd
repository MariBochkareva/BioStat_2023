...
```
#Рассчеты по уровню гемоглобина: 
...
percent_low_hb <- round((total_low_hb / nrow(trauma_data_cleaned)) * 100, 1)
...
*Процент пациентов с сниженным уровнем гемоглобина: 44.7 %*
...
roc_gcs %>% 
  ...
  geom_abline(slope = 1, intercept = 1, color = "grey") +
  theme_bw() +
    ggtitle("ROC Curve for Hemoglobin Level Predicting 24-hour Mortality") +
  theme_bw() +
  theme(plot.title = element_text(size = 6))
